...
### [빌트인 객체](/Javascript/빌트인%20객체.md)

- 빌트인 객체가 뭔가요? 종류는 어떤게 있죠?
- 래퍼 객체에 대해서 알고 있나요?
- 꼭 생성자 함수로 정의해야 하나요?

### [실행 컨텍스트](/Javascript/실행%20컨텍스트.md)
...
### [리액트에서 함수형 컴포넌트라고 부르지 않고 함수 컴포넌트라고 부르는 이유가 무엇인가요](/React/함수형%20컴포넌트라고%20부르지%20않고%20함수%20컴포넌트라고%20부르는%20이유.md)
